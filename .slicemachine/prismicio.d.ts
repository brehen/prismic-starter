...
/** Content for image card section documents */
type ImageCardSectionDocumentData = Record<string, never>;
/**
 * image card section document from Prismic
 *
 * - **API ID**: `image_card_section`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/core-concepts/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type ImageCardSectionDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<Simplify<ImageCardSectionDocumentData>, "image_card_section", Lang>;
...
interface PageDocumentData {
    ...
    /**
     * Heisann field in *Page*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: page.heisann
     * - **Tab**: Second
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    heisann: prismicT.RichTextField;
    /**
     * Slice Zone field in *Page*
     *
     * - **Field Type**: Slice Zone
 ...
 *
 */
type PageDocumentDataSlices1Slice = QuoteSlice;
/**
...
export type AllDocumentTypes = ArticleDocument | ImageCardSectionDocument | NavigationDocument | PageDocument | SettingsDocument;
/**
